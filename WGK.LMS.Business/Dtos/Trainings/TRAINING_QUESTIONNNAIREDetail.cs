...
namespace WGK.LMS.Business.Dtos.Trainings
{
    ...
    public class TRAINING_QUESTIONNNAIREDetail : BaseChildEntityModel
    {
        ...
        public TRAINING_QUESTIONNNAIREDetail()
        {
            ...
            this.QUESTIONNAIREDetails = new WGK.LMS.Business.Dtos.Questionnaires.QUESTIONNAIREDetail();
        ...
        public Questionnaires.QUESTIONNAIREDetail QUESTIONNAIREDetails { get; set; }
