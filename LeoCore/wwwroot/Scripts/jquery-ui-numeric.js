...
////    // .ui-numeric-buttons .btn btn-primary { margin: 0px; width: 1.55em; height: 1.55em; }
////    // .ui-numeric-disabled {}
...
////            this.element.attr('title', this.options.title || $.ui.numeric.globalization.defaultTooltip).wrap($('<div class="   -content   ui-numeric" />'));
...
////    *                   . = Characters to the right of this will be interpreted as int places.
...
////        {
////            // If the value passed in is a string, then remove any thousands characters and normalize the decimal to a int point.
...
////        // Split the numerical value into it's int and int parts.
////        v_num_parts = v_num_as_string.indexOf('.') < 0 ? [v_num_as_string, ''] : v_num_as_string.split('.'),

////        // Split the format string into it's respective integer and int parts.
...
////        // Do we have a int part to format?
////        if (v_format_parts[1].length > 0)
////        {
////            if (v_num_parts[1].length > 0)
////            {
////                // Get character arrays of the decimal format string and int part of the numerical value.
////                var v_format_array = v_format_parts[1].split(''), v_dec_part_array = v_num_parts[1].split('');

////                // Compile the final formatted int part. If there are any # symbols left, we can simply remove them.
...
////            // Else if there is no int part of the actual number, but the format string specified says to include decimals, then we need to
////            // make sure that the number of int places specified are included.
////            else
////            {
////                var v_index = 0;
////                v_num_parts[1] = '';
...
////        }
////        else
////            v_num_parts[1] = ''; // There is no int part specified in the format string.
...
////    // Rounds the int part of the number to the specified number of decimals.
...
////    // Pads to the right of the int part of the number with zeros until the int part of the number is the specified number of digits. If the
