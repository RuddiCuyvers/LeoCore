...
namespace WGK.Lib.Validation
{
    public class IbanValidator : IIbanValidator
    {
        ...
        public bool Validate(string pIban, UseCases.IValidationDictionary pValidationDictionary, string pPropertyKey, string pPropertyDisplayName)
        {
            //Leestekens verwijderen
            string mysIBAN = pIban.Replace(" ", "");
            ...
            else
            {
                ...
                {
                    pValidationDictionary.AddError(pPropertyKey, pPropertyDisplayName + " moet een geldig formaat hebben.");
