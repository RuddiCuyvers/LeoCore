...
//
// Bundled with VS (both 2008 and 2010) installation under the following path in VS installation directory:
// Samples\1033\CSharpSamples.zip\LinqSamples\DynamicQuery\DynamicQuery
// Source in 'Dynamic.cs' file, documentation in 'Dynamic Expressions.html' file.
//
// The Dynamic Expression API implements a subset of the LINQ extension methods in a late-bound, string-based manner.
// It extends the core LINQ API with the following features:
// - Dynamic parsing of strings to produce expression trees (the ParseLambda and Parse methods),
// - Dynamic creation of “Data Classes” (the CreateClass methods)
// - Dynamic string-based querying through LINQ providers (the IQueryable extension methods).
//
// Below is an example of applying the Dynamic Expression API to a LINQ to SQL data source:
//
//var query =
//    db.Customers.
...
// MODIFIED - Renamed to WGK.Lib.Extensions namespace
// namespace System.Linq.Dynamic
namespace WGK.Lib.Extensions
{
    /// <summary>
    /// Addition to Microsoft's code
    /// </summary>
