...
namespace LEO.Business.Mappers.Trainings
{
    ...
    public class TrainingMerger :
        ...
        IMerger<LEO.Business.Dtos.Trainings.TRAINING_QUESTIONNNAIREDetail, TRAINING_QUESTIONNNAIRE>
    {
         ...
         //   if (pInto.NC_ROL_DURATION != (pFrom.NC_ROL_DURATION))
          ...
          //  }
           ...
           // {
            ...
            {
                pInto.EV_PERS_DURATION = pFrom.EV_PERS_DURATION;
            }
            ...
            {
                pInto.EV_ANDERS_DURATION = pFrom.EV_ANDERS_DURATION;
            }
