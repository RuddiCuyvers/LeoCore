...
namespace LEO.Business.Mappers.Trainings
{
    /// <summary>
    ...
    public class TrainingMapper :
        ...
        IMapper<TRAINING_QUESTIONNNAIRE, LEO.Business.Dtos.Trainings.TRAINING_QUESTIONNNAIREDetail>
    {
        ...
        private String TijdMinutenNaarStringconversie(decimal? pTijd)
        {
            if(pTijd == null)
            {
                return ""; ;
        ...
        public TRAINING_QUESTIONNNAIREDetail Map(TRAINING_QUESTIONNNAIRE pSource)
        {
            ...
            var vTRAINING_QUESTIONNNAIREDetail = new TRAINING_QUESTIONNNAIREDetail
            {
                ...
                QUESTIONNAIREDetails = MapHelper.MapSingle(pSource.QUESTIONNAIRE).To<LEO.Business.Dtos.Questionnaires.QUESTIONNAIREDetail>()
            };
